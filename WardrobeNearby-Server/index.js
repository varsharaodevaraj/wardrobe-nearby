...
const communitiesRoutes = require('./routes/communities'); // NEW
...
app.use('/api/communities', communitiesRoutes); // NEW
...
io.on('connection', (socket) => {
  ...
  socket.on('startTyping', (data) => {
    ...
    console.log(`User ${socket.userId} started typing in chat ${chatId}`);
  });
