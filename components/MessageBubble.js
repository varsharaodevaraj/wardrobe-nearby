  ...
  const handleItemPress = () => {
    if (message.itemInfo?.itemId) {
      navigation.navigate("ItemDetail", {
        item: { _id: message.itemInfo.itemId },
      });
    }
  };
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <Image
              source={{ uri: message.itemInfo.itemImage }}
              style={styles.requestImage}
            />
            <View style={styles.requestTextContainer}>
              <Text
                style={[styles.requestTitle, isOwn && styles.ownMessageText]}
              >
                {message.itemInfo.itemName}
              </Text>
              <Text
                style={[styles.requestSubtitle, isOwn && styles.ownMessageText]}
              >
                Rental Request Sent
              </Text>
            </View>
